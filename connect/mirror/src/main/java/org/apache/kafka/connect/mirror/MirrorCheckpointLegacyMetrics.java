...
import static org.apache.kafka.connect.mirror.MirrorCheckpointMetrics.LATENCY_MS;
import static org.apache.kafka.connect.mirror.MirrorCheckpointMetrics.LATENCY_MS_AVG;
import static org.apache.kafka.connect.mirror.MirrorCheckpointMetrics.LATENCY_MS_AVG_DESCRIPTION;
import static org.apache.kafka.connect.mirror.MirrorCheckpointMetrics.LATENCY_MS_DESCRIPTION;
import static org.apache.kafka.connect.mirror.MirrorCheckpointMetrics.LATENCY_MS_MAX;
import static org.apache.kafka.connect.mirror.MirrorCheckpointMetrics.LATENCY_MS_MAX_DESCRIPTION;
import static org.apache.kafka.connect.mirror.MirrorCheckpointMetrics.LATENCY_MS_MIN;
