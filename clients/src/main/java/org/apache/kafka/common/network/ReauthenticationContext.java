...
public class ReauthenticationContext {
     ...
     * Constructor
     *
     * @param previousAuthenticator the mandatory {@link Authenticator} that was previously used to
     *                              authenticate the channel
     * @param networkReceive        the applicable {@link NetworkReceive} instance, if any. For the
     ...
     * @param nowNanos              the current time. The value is in nanoseconds as per
